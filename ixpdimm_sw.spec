%define build_version 01.00.00.2111
...
Requires:       ixpdimm-cli%{?_isa} = %{version}-%{release}
...
Group:          Development/Libraries
Requires:       libixpdimm-core%{?_isa} = %{version}-%{release}
Requires:       ixpdimm_sw%{?_isa} = %{version}-%{release}
Requires:       pywbem
Requires(pre):  pywbem
...
%changelog
* Fri Sep 09 2016 Eric Sandeen <sandeen@redhat.com> - 01.00.00.2111-1
- Downgrade to v01.00.00.2113 to satisfy existing RHEL7 deps
- Add explicit inter-package dependencies
- Resolves: rhbz#1270993

* Thu Sep  1 2016 Dave Anderson <anderson@redhat.com> - 01.00.00.2113-1
- Copied upstream v01.00.00.2113.tar.gz into ixpdimm_sw-01.00.00.2113.tar.gz
  and did an rhpkg new-sources to replace the mismatched checksum version 
  included in the Fedora src.rpm
- Resolves: rhbz#1270993
